      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            }} disabled={uploadId !== "" || uploading} type="submit" className={`w-full ${deployed ? 'bg-green-500' : ''}`} 
            >
              {deployed ? `Deployed (${uploadId}) 🎉` : uploadId ? `Deploying (${uploadId})` : uploading ? "Uploading..." : "Upload"}
            </Button>
          </div>
        </CardContent>
      </Card>
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          ...
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.10kdevs.com:3001/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
